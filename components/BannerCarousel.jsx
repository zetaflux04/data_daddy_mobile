...
export const defaultBanners = [
    {
        ...
        subtitle: 'Extra 15% discount on iPhone 13/14 OLED combos and Samsung display panels ordered this week.',
        ctaText: 'Claim Offer',
        ctaRoute: '/notifications',
        gradientColors: ['#1E3A8A', '#1E40AF', '#172554'],
        badgeIcon: 'gift',
        badgeBg: '#F59E0B',
    },
    {
        ...
        subtitle: 'Deliver automated order received, repair completion, and delivery alerts instantly to your customers.',
        ctaText: 'Explore Features',
        ctaRoute: '/settings',
        gradientColors: ['#0369A1', '#0284C7', '#0C4A6E'],
    ...
    },
    {
        ...
        subtitle: 'Access 250+ step-by-step schematics, boardviews, and short-circuit troubleshooting diagrams.',
        ctaText: 'Browse Guides',
        ctaRoute: '/guides',
        gradientColors: ['#065F46', '#047857', '#022C22'],
        badgeIcon: 'construct',
        badgeBg: '#10B981',
    },
    {
        ...
        subtitle: 'Track technician commissions, print barcode receipts, and calculate real-time net margins easily.',
        ctaText: 'Explore Pro',
        ctaRoute: '/analytics',
        gradientColors: ['#581C87', '#6D28D9', '#3B0764'],
