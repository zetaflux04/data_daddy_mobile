        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            >
              ...
              {showDeviceType && (
                <>
                  <Text style={[styles.sectionHeader, { color: isDark ? '#8696A0' : '#64748B' }]}>DEVICE TYPE</Text>
                  <View style={styles.chipsRow}>
              ...
              <Text style={[styles.sectionHeader, { color: isDark ? '#8696A0' : '#64748B' }]}>PAYMENT STATUS</Text>
              <View style={styles.chipsRow}>
              ...
              {/* TECHNICIAN Section */}
              <Text style={[styles.sectionHeader, { color: isDark ? '#8696A0' : '#64748B' }]}>TECHNICIAN</Text>
              <View style={styles.chipsRow}>
                <Pressable
                  style={[
                    styles.chip,
                    {
                      backgroundColor: selectedTechnician === 'anyone' ? Colors.primary : (isDark ? '#202C33' : '#FFFFFF'),
                      borderColor: selectedTechnician === 'anyone' ? Colors.primary : (isDark ? '#2A3942' : '#E2E8F0'),
                    },
                  ]}
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.chipText,
                      { color: selectedTechnician === 'anyone' ? '#FFFFFF' : (isDark ? '#E9EDEF' : '#475569') },
                ...
                <Pressable
                  style={[
                    styles.chip,
                    {
                      backgroundColor: selectedTechnician === 'not_assigned' ? Colors.primary : (isDark ? '#202C33' : '#FFFFFF'),
                      borderColor: selectedTechnician === 'not_assigned' ? Colors.primary : (isDark ? '#2A3942' : '#E2E8F0'),
                    },
                  ]}
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.chipText,
                      { color: selectedTechnician === 'not_assigned' ? '#FFFFFF' : (isDark ? '#E9EDEF' : '#475569') },
                      selectedTechnician === 'not_assigned' && styles.chipTextSelected,
                    ]}
                  >
                    Not assigned
                  </Text>
