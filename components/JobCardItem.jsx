    ...
    return (<Pressable onPress={onPress} style={({ pressed }) => [
      ...
      <View style={styles.cardHeader}>
        ...
        <View style={styles.deviceIconCircle}>
          <Ionicons name={job.deviceType === 'laptop'
            ? 'laptop-outline'
            : job.deviceType === 'tablet'
                ? 'tablet-portrait-outline'
                : job.deviceType === 'smartwatch'
                    ? 'watch-outline'
                    : 'phone-portrait-outline'} size={22} color={Colors.primary}/>
        </View>
        ...
        <View style={styles.headerInfoCol}>
          ...
          {(job.repairedBy?.name || (typeof job.assignedTechnicianId === 'object' && job.assignedTechnicianId?.name)) && (<View style={styles.repairedByTag}>
      ...
      <View style={styles.bottomRow}>
        ...
        <View style={styles.rightMetaRow}>
          ...
          <Pressable style={({ pressed }) => [styles.smsBtn, { opacity: pressed ? 0.75 : 1 }]} onPress={handleSmsPress}>
