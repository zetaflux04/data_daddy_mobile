...
export const DateFilterBar = ({ selectedRange, onRangeChange, customStartDate, customEndDate, }) => {
    ...
    return (<View style={styles.container}>
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        {filterTabs.map((tab) => {
            ...
            return (<Pressable key={tab.key} onPress={() => handleTabPress(tab.key)} style={[
                    styles.chip,
                    isSelected && styles.chipSelected,
                ]}>
              <Ionicons name={tab.icon} size={13} color={isSelected ? Colors.primary : '#64748B'} style={{ marginRight: 4 }}/>
      ...
      <Modal visible={isCustomModalOpen} transparent animationType="fade" onRequestClose={() => setIsCustomModalOpen(false)}>
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.presetsRow}>
              <Pressable style={styles.presetChip} onPress={() => {
            const now = new Date();
